...
import { LayoutDashboard, HardHat, Settings, LogOut, Building2, BarChart2, ChevronRight, Users } from "lucide-react";
...
const allNav = [
  ...
  { to: "/clientes", label: "Clientes", icon: Users, roles: ["admin", "gestor"] as const },
